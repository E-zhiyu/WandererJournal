...
public class AboutHelper {
    private final static String CHANGELOG = "# v1.5.5\n" +
            ...
            "### BUG修复\n" +
            "\n" +
            "- 修复角色选择对话框无法显示常用角色的BUG\n" +
            "- 尝试修复在写日记界面中显示浮窗并展开键盘，然后关闭浮窗收起键盘并在关闭浮窗后自动弹出键盘时，输入框会跌落到键盘下方的BUG\n" +
            "- 修复进入读日记界面并默认滚动到最顶部时，最顶部的日期分隔符不会闪烁的BUG\n" +
            ...
            "\n" +
            "- 修复上个版本添加角色会失败的BUG\n" +
            "- 修复角色输入界面点击显示名称输入框会清空名称输入框的错误提示的BUG\n" +
            "\n" +
            "# v1.5.2\n" +
            "\n" +
            "### BUG修复\n" +
            ...
            "### BUG修复\n" +
            "\n" +
            "- 修复显示段落筛选对话框时翻转屏幕或调整深浅色模式后无法正常触发筛选逻辑的BUG\n" +
            ...
            "\n" +
            "- 优化角色列表加载速度\n" +
            "- 记忆像素支持响应式更新，避免修改了日记后没有及时更新显示数据的情况发生\n" +
            "- 从记忆像素跳转至读日记界面后日记长度浮窗会自动关闭\n" +
            "- 情绪标签列表界面按照情绪类型分组\n" +
            "- 情绪标签选择对话框和段落过滤对话框设置添加情绪标签的入口\n" +
            "- 优化部分界面的动画效果\n" +
            "- 读日记界面初始滚动成功后会折叠标题栏，防止遮挡底部内容\n" +
            "- 写日记界面和日记列表界面触发滚动时会折叠标题栏防止底部内容被遮挡\n" +
            "- 优化身份验证逻辑，现在会跳转到专门的身份验证界面\n" +
            "- 优化角色选择对话框的布局\n" +
            "- 点击记忆像素无日记的部分显示的浮窗不再带有跳转至读日记界面的按钮\n" +
            "- 添加角色时若有重复的名称会弹出提醒\n" +
            "- 部分界面添加使用引导\n" +
            "- 写日记界面添加新段落后会折叠标题栏，避免最底下的段落无法完全显示\n" +
            "- 角色名称输入时名称不能包含英文中括号\n" +
            "\n" +
            "### BUG修复\n" +
            "\n" +
            "- 尝试修复在HyperOS中进入统计界面记忆像素无法正常滚动到尾部的BUG\n" +
            "- 修复打开部分底部弹出式对话框时翻转屏幕或者切换深浅色模式会导致崩溃的BUG\n" +
