...
public class MonthHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private final List<DiaryLengthUnionModel> dataList;
    private final Paint paint;
    private final int topMargin;

    public MonthHeaderDecoration(List<DiaryLengthUnionModel> dataList, Context context) {
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            DiaryLengthUnionModel item = dataList.get(position);
